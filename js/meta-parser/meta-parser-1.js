...
(function() {
    // Проверяем, не объявлены ли классы уже
    if (typeof MetaCache !== 'undefined') {
        console.log('⚠️ MetaCache уже объявлен, пропускаем создание');
        return;
    }
    ...
    // Проверяем, не объявлен ли HierarchyBuilder
    if (typeof HierarchyBuilder !== 'undefined') {
        console.log('⚠️ HierarchyBuilder уже объявлен, пропускаем создание');
    } else {
        /**
